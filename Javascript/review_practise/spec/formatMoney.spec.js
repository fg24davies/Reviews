...
describe('formatMoney', () => {
  test.skip('it turns takes 2dp number and returns in dollar and cents', () => {
  ...
  test.skip('it turns takes a number with 0dp and adds 00', () => {
    expect(formatMoney(3)).toEqual ('$3.00')
  });

  test.skip('it turns takes a number with 1dp and adds 0', () => {
    expect(formatMoney(3.1)).toEqual ('$3.10')
  });

  test.skip('it turns takes 0 and returns $0.00', () => {
