...
describe('Plant', () => {
  ...
  test('it grows a 2 stem 2 flower at correct temp ', () => {
    expect(plant("@", 2, 2, 20)).toEqual("--@@--@@")
  });

   test('it only produces 1 flower at the end of the right amount of stem if temperature is not in 20-30 incl ', () => {
    expect(plant("@", 2, 2, 19)).toEqual("----@")
  });
  
  test('it grows a 4 stem 2 flower at correct temp ', () => {
